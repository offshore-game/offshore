      ...
      <div id="sizingContent">
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/test/" element={ <div style={{backgroundColor: "white", height: "100%", width: "100%", display: "flex", justifyContent: "center", alignItems: "center"}}> <WireConnection count={1}/> </div> } />
          </Routes>
        </BrowserRouter>
      </div>
    </div>

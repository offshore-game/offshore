    ...
    return (
        <Home>
            ...
            <p style={{ margin: "2%" }}>
                    ...
                    When the game begins, a five-minute timer and a 100 health point health bar for the boat will appear at the top of the screen. 
                    ...
                    Solving a puzzle correctly will grant the crewmate who did so 10 coins, and a 5-second bonus to all puzzle timers for everyone. Crewmates with the highest amount of coins by the end of the run will be recognized for their contributions towards keeping the ship afloat.
                    ...
                    Incorrectly instructing the crewmates, or allowing for one of the puzzle timers to run out results in the loss of 10 health points for the boat.

                    But that's not all… when multiple captains are present, each captain's manual may sometimes hold only a piece of the solution necessary to solve the puzzle; captains must communicate all of their solutions to the crewmates in order to complete some puzzles.
